...
reported to the community leaders responsible for enforcement, see [SUPPORT](SUPPORT.md).
...
This Code of Conduct is adapted from the [Contributor Covenant][homepage] and [Flutter CoC][Flutter CoC],
version [2.1][v2.1].
...
[Flutter CoC]: https://github.com/flutter/flutter/blob/master/CODE_OF_CONDUCT.md